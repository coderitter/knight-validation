    ...
    describe('validate', function() {
      describe('single property', function() {
        ...
        it('should not return a misfit for not supported types', async function() {
          ...
          expect(await max.validate({ value: true }, 'value')).to.be.null
          expect(await max.validate({ value: {} }, 'value')).to.be.null
          expect(await max.validate({ value: undefined }, 'value')).to.be.null
          expect(await max.validate({ value: null }, 'value')).to.be.null
          expect(await max.validate({ value: new Date }, 'value')).to.be.null
          expect(await max.validate({ value: NaN }, 'value')).to.be.null
        })
      })
      ...
      describe('property combination', function() {
        ...
        it('should not return a misfit for not supported types', async function() {
          let max = new Bounds({ lesserThan: 5, greaterThan: 2 })
          expect(await max.validate({ value1: true, value2: true }, [ 'value1', 'value2' ])).to.be.null
          expect(await max.validate({ value1: {}, value2: {} }, [ 'value1', 'value2' ])).to.be.null
          expect(await max.validate({ value1: undefined, value2: undefined }, [ 'value1', 'value2' ])).to.be.null
          expect(await max.validate({ value1: null, value2: null }, [ 'value1', 'value2' ])).to.be.null
          expect(await max.validate({ value1: new Date, value2: new Date }, [ 'value1', 'value2' ])).to.be.null
          expect(await max.validate({ value1: NaN, value2: NaN }, [ 'value1', 'value2' ])).to.be.null
        })
      })
    })
  })
